...
with app.app_context():
    ...
    mobPsycho100 = TvShows(title="Mob Psycho 100", descr="A student tries to learn to control his incredible psychic powers while exorcising various spirits with the help of a con artist.", num_seasons=1, num_episodes=12, picture="mob.jpg", finished_airing=True)
    ...
    mandalorian = TvShows(title="The Mandalorian", descr="A space bounty hunter goes on an adventure with a powerful child.", num_seasons=2, num_episodes=24, picture="The_Mandalorian.svg", finished_airing=False)
