...
with app.app_context():
    ...
    onePunchMan = TvShows(title="One Punch Man", descr="An interesting super hero can defeat any of his enemies in just one punch.", num_seasons=2, num_episodes=24, picture="opm.jpg")
    mandalorian = TvShows(title="The Mandalorian", descr="A space bounty hunter goes on an adventure with a powerful child.", num_seasons=2, num_episodes=24, picture="The_Mandalorian.svg")
